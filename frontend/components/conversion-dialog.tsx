...
type MappingMode = "auto" | "custom";

const PARQUET_COMPRESSION_OPTIONS: ParquetCompression[] = [
  "none",
  "snappy",
  "gzip",
  "brotli",
...
const TFRECORD_COMPRESSION_OPTIONS: TFRecordCompression[] = ["none", "gzip"];
const RESAMPLE_METHOD_OPTIONS: ResampleMethod[] = ["downsample", "interpolate"];
...
function createDefaultFormState(): ConversionFormState {
  return {
    mapping: {
      customJson: "",
      mode: "auto",
...
function parseCustomMapping(customJson: string) {
