...
- [dashboard-phased-implementation.md](./dashboard-phased-implementation.md): phased plan for a dashboard that starts with existing APIs and later adds summary routes and quality rollups
